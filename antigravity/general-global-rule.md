...
> 五阶段详细 SOP、各 Agent 触发差异、Git 检查点机制 → 见 `workflows/` 目录与 `wiki/agent-rules/five-step-pipeline.md`
...
三条升级通道（细节见 `workflows/promote-lessons.md`）：留在项目 `tasks/lessons.md` / 升级进 Wiki / 固化为 Skill。
